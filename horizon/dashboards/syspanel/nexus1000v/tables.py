...
class CreateNetworkProfile(tables.LinkAction):
    ...
    url = "horizon:syspanel:nexus1000v:create_network_profile"
...
class DeleteNetworkProfile(tables.DeleteAction):
    ...
    def delete(self, request, obj_id):
        try:
            ...
            LOG.info(msg)
            redirect = reverse('horizon:syspanel:nexus1000v:index')
...
class EditNetworkProfile(tables.LinkAction):
    ...
    url = "horizon:syspanel:nexus1000v:update_networkprofile"
