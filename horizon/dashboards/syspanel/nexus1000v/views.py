...
def _get_profiles(request, type=None):
    try:
...
class NetworkProfileIndexView(tables.DataTableView):
    ...
    template_name = 'syspanel/nexus1000v/network_profile/index.html'
...
class PolicyProfileIndexView(tables.DataTableView):
    ...
    template_name = 'syspanel/nexus1000v/policy_profile/index.html'
...
class CreateNetworkProfileView(forms.ModalFormView):
    ...
    template_name = 'syspanel/nexus1000v/create_network_profile.html'
    success_url = reverse_lazy('horizon:syspanel:nexus1000v:index')

class UpdateNetworkProfileView(forms.ModalFormView):
    form_class = UpdateNetworkProfile
    template_name = 'syspanel/nexus1000v/update_network_profile.html'
